...
<?php $this->load->view('themes/admin/breadcrumb');	?>
	<div id="content">
		<div class="m-b-10">
           <div class="pull-left">
               <h3 class="pull-left">
                   <strong>Email Templates List</strong>
               </h3>
           </div>
           <div class="pull-right">
               <a href="<?php echo base_url('admin/emails/addEmailTemplate');?>" class="btn btn-primary">
                                ...
                                <table id="dt_basic" class="table table-striped table-bordered table-hover" width="100%">
                                    ...
                                    <tbody>
                                        ...
                                        <tr id="<?=$template->id.'_A';?>">
											...
											<td>
												<?=(!empty($template->template_subject)) ? $template->template_subject : 'N/A';?>
											</td>
											<td>
												<?=(!empty($template->template_header)) ? $template->template_header : 'N/A';?>
											</td>
											<td>
											...
											<td>
												<?=(!empty($template->template_content)) ? ellipsize($template->template_content, 50) : 'N/A';?>
											</td>
                                            <td>
												<?php
											...
											<td>
												<a class="btn btn-success view<?=$template->id;?>" href="<?=base_url('admin/emails/editEmailTemplate/'.$template->id)?>" >Edit</a>
											</td>
                                        </form>
                                        </tr>
                                        <?php } }?>
