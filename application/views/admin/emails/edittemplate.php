            ...
            <div data-widget-editbutton="false" id="8521cbb7b77c1acb05ccf76f73014447" class="jarviswidget jarviswidget-sortable" role="widget">
                <div role="content">
                    ...
                    <div class="widget-body ">
                        <div class="tabbable">
                            <form class="smart-form" id="static-cpage-content"  method="post" data-parsley-validate="" enctype="multipart/form-data" action="<?=current_url(); ?>">
                                                    ...
                                                    <div class="col-lg-12 col-sm-12">
                                                        <fieldset>
                                                            ...
                                                            <section>
                                                                ...
                                                                <label class="input">
                                                                    <input type="text" placeholder="Template Subject" name="template_subject" data-parsley-range="[3, 255]" required=""  value="<?=(!empty($template->template_subject)) ? $template->template_subject :'';?>">
                                                                </label>
                                                            </section>
                                                            <section>
                                                                <label class="label">Template Header <span class="asterisk">*</span></label>
                                                                <label class="input">
                                                                    <input type="text" placeholder="Template Header" name="template_header" data-parsley-range="[3, 255]" required=""  value="<?=(!empty($template->template_header)) ? $template->template_header :'';?>">
                                                                </label>
                                                            </section>
                                                            <section>
                                                                ...
                                                                <label class="input">
																	<div role="content">
																		...
																		<div class="widget-body no-padding">
																			<textarea name="template_content" class="ckeditor" required style="visibility: hidden; display: none;"><?=(!empty($template->template_content)) ? $template->template_content :'';?></textarea>
																		</div>
                                                                </label>
                                                            </section>
                                                            <section>
                                                                ...
                                                                <label class="textarea">
                                                                    <textarea placeholder="Template Text" name="template_text" data-parsley-range="[3, 255]" required=""><?=(!empty($template->template_text)) ? $template->template_text :'';?></textarea>
                                                                </label>
                                                            </section>
                                                            <section>
