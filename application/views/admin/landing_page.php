<!-- EASY PIE CHARTS -->
<script src="http://192.168.1.22/smart-admin/js/plugin/easy-pie-chart/jquery.easy-pie-chart.min.js"></script>

<!-- SPARKLINES -->
<script src="http://192.168.1.22/smart-admin/js/plugin/sparkline/jquery.sparkline.min.js"></script>
<!-- ==========================CONTENT STARTS HERE ========================== -->
