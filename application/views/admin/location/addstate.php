                                            ...
                                            <article class="col-xs-12 col-sm-12 col-md-12 col-lg-12 sortable-grid ui-sortable">
                                                    <div class="col-lg-12 col-sm-12">
                                                        <fieldset>
                                                            ...
                                                            <section>
                                                                <label class="label">State Name <span class="asterisk">*</span></label>
                                                                <label class="input"> 
                                                                    <i class="icon-append fa fa-map-marker"></i>
                                                                    <input type="text" placeholder="State Name" name="name" data-parsley-length="[3, 50]" required="" data-parsley-pattern="^[a-zA-Z ]{2,50}$"   value="<?=set_value('name')?>">
                                                                </label>
                                                            </section>
