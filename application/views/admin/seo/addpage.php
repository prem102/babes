                                                    ...
                                                    <div class="col-lg-12 col-sm-12">
                                                        <fieldset>
                                                            ...
                                                            <section>
                                                                ...
                                                                <label class="input">
                                                                    <input type="text" placeholder="Meta Title" name="meta_title" required=""  value="<?=set_value('meta_title')?>">
                                                                </label>
                                                            </section>
                                                            <section>
                                                                <label class="label">Meta Keywords <span class="asterisk">*</span></label>
                                                                <label class="textarea">
                                                                    <textarea placeholder="Meta Keywords" name="meta_keywords" required=""><?=set_value('meta_keywords')?></textarea>
                                                                </label>
                                                            </section>
                                                            <section>
                                                                <label class="label">Meta Description <span class="asterisk">*</span></label>
                                                                <label class="textarea">
                                                                    <textarea placeholder="Meta Description" name="meta_description" required=""><?=set_value('meta_description')?></textarea>
                                                                </label>
                                                            </section>
                                                            <section>
