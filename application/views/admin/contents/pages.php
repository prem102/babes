		...
		<div class="m-b-10">
           <div class="pull-left">
			...
			<div class="pull-right">
			   <a href="<?php echo base_url('admin/contents/addpage');?>" class="btn btn-primary"><i class="fa fa-plus"></i>Add Page</a>
			</div>
			<?php
				}
			?>
                                ...
                                <table id="dt_basic" class="table table-striped table-bordered table-hover" width="100%">
                                    ...
                                    <tbody>
                                        ...
                                        <tr id="<?=$page->id.'_A';?>">
											...
											<td>
												<?=(!empty($page->variables)) ? $page->variables : 'N/A';?>
											</td>
											<td>
												<?=(!empty($page->page_content)) ? ellipsize($page->page_content, 50) : 'N/A';?>
											</td>
                                            <td>
												<?php
											...
											?>
											<td>
												<a class="btn btn-success view<?=$page->id;?>" href="<?=base_url('admin/contents/editpage/'.$page->id)?>" >Edit</a>
											</td>
											<?php } ?>
                                        </form>
                                        </tr>
