                                                    ...
                                                    <div class="col-lg-12 col-sm-12">
                                                        <fieldset>
                                                            ...
                                                            <section>
                                                                ...
                                                                <label class="input">
                                                                    <input type="text" placeholder="Label" name="variable_name" required=""  value="<?=set_value('variable_name')?>">
                                                                </label>
                                                            </section>
                                                            <section>
                                                                ...
                                                                <label class="input">
																	<div role="content">
																		...
																		<div class="widget-body no-padding">
																			<textarea name="variable_value" class="ckeditor" required style="visibility: hidden; display: none;"><?=set_value('variable_value')?></textarea>
																		</div>
                                                                </label>
                                                            </section>
                                                            <section>
