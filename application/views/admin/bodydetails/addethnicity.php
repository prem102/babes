            ...
            <div data-widget-editbutton="false" id="8521cbb7b77c1acb05ccf76f73014447" class="jarviswidget jarviswidget-sortable" role="widget">
                <div role="content">
                    ...
                    <div class="widget-body ">
                        <div class="tabbable">
                            <?= form_open( current_url(), ['class' => 'smart-form','id' => 'ethnicity-form','enctype'=>"multipart/form-data",'data-parsley-validate'=>"data-parsley-validate"]); ?>
                                                    ...
                                                    <div class="col-lg-12 col-sm-12">
                                                        <fieldset>
                                                            ...
                                                            <section>
                                                                ...
                                                                <label class="input">
                                                                    <input type="text" placeholder="Ethnicity" name="name" data-parsley-length="[3, 50]" required="" data-parsley-pattern="^[a-zA-Z ]{2,50}$"   value="<?=set_value('name')?>">
                                                                </label>
                                                            </section>
